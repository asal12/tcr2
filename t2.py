...
admin = ["u0bda852feb6276a7f8abdd05dc5614f2","u69fce3b402e73045a5f02e9e1678765e","u49694977c0d003314e9d0144dc2d0e19"]
staff = ["u0bda852feb6276a7f8abdd05dc5614f2","u69fce3b402e73045a5f02e9e1678765e","u49694977c0d003314e9d0144dc2d0e19"]
adminMID = ["u0bda852feb6276a7f8abdd05dc5614f2"]
creator = ["u0bda852feb6276a7f8abdd05dc5614f2"]
wait = {
    'contact':True,
    'autoJoin':True,
...
#-----------------------[Kick Section]------------------------
            ...
            elif msg.text in ["KillBan","killban"]:
                if msg.toType == 2:
                    if msg.from_ in admin:
...
#-----------------------[Bot(s) Leave Section]------------------------
            ...
            elif msg.text in ["Bye bot1","bye bot1"]:
                if msg.toType == 2:
                    if msg.from_ in admin:
                        ginfo = cl.getGroup(msg.to)
                        try:
            ...
            elif msg.text in ["Bye bot2","bye bot2"]:
                if msg.toType == 2:
                    if msg.from_ in admin:
            ...
            elif msg.text in ["Bye bot3","bye bot3"]:
                if msg.toType == 2:
                    if msg.from_ in admin:
            ...
            elif msg.text in ["Bye bot4","bye bot4"]:
                if msg.toType == 2:
                    if msg.from_ in admin:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in staff:
                try:    
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ig @yogash12")
                    print "Like"
                except:
                    pass
            else:
